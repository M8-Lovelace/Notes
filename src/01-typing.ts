...
(() => {
  // Si una variable no se va a asignar, se debe tipar siempre o se asignará any
  ...
  // NUMBERS //
  // [int, float, octal: "0o0771234", hex: "0xfff", binary: "ob1010", NaN, Infinity]
  ...
  // NULL & UNDEFINED//
  // depende el caso de uso para asignar estos valores con union types
  ...
  // NEVER //
  // Significa que el valor nunca va a existir, se usa en funciones que lanzan excepciones
