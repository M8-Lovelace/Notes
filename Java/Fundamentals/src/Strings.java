public class Strings {
  public static void main(String[] args) {
    ...
    // StringBuilder es una clase que permite crear un objeto mutable de tipo String.
    ...
    //  Método que ejecuta el garbage collector del sistema. Realiza un reciclado de los objetos de la memoria
    ...
    // El primer argumento es el caracter a buscar y el segundo el caracter a reemplazar.
    ...
    // Compara orden numérico de las cadenas basado en el valor Unicode de cada carácter, si es menor a 0 es menor, si es mayor a 0 es mayor, si es igual a 0 es igual
    ...
    // Verifica si la cadena está vacía, valida la longitud y si tiene espacios en blanco
    ...
    // --------------------------------------------------------------------//
    // -----------------------------MÉTODOS--------------------------------//
    // Los métodos de la clase String son inmutables, no modifican el String original.
    // Devuelven un nuevo String con el resultado.
    // Los métodos de la clase String son estáticos, se pueden invocar sin crear un objeto.
    // Los métodos de la clase String son públicos, se pueden invocar desde cualquier clase.
    ...
    // Obtiene una subcadena de la cadena, desde la posición indicada hasta la posición indicada
    System.out.println("nombre3.substring(1, 4) = " + nombre3.substring(1, 4)); // aur
    // Obtiene una subcadena de la cadena, desde la posición indicada hasta la posición indicada, pero de forma inversa
    System.out.println("nombre3.substring(4, 6) = " + nombre3.substring(nombre.length() - 2)); // ra

    String trabalenguas = "trabalenguas";

    // Reemplaza todas las ocurrencias de la cadena que se pasa como primer argumento, por la cadena que se pasa como segundo argumento
    ...
    // Nos da la posición de la primera ocurrencia de la cadena que se pasa como argumento
    System.out.println("trabalenguas.indexOf(\"a\") = " + trabalenguas.indexOf("a")); // 1
    // Nos da la posición de la última ocurrencia de la cadena que se pasa como argumento
    System.out.println("trabalenguas.lastIndexOf(\"a\") = " + trabalenguas.lastIndexOf("a")); // 9
    // Nos dice si la cadena que se pasa como argumento está contenida en la cadena, si da un valor mayor a -1 es que está contenida
    System.out.println("trabalenguas.indexOf(\"t\") = " + trabalenguas.indexOf("t")); // 0
    // Nos dice si está contenida la cadena que se pasa como argumento en la cadena, si da un valor true es que está contenida
    System.out.println("trabalenguas.contains(\"t\") = " + trabalenguas.contains("t")); // true
    // Nos dice si la cadena que se pasa como argumento empieza con la cadena, si da un valor true es que empieza con la cadena
    System.out.println("trabalenguas.startsWith(\"tra\") = " + trabalenguas.startsWith("tra")); // true
    // Nos dice si la cadena que se pasa como argumento termina con la cadena, si da un valor true es que termina con la cadena
    ...
    // Convierte la cadena a un arreglo de caracteres, separando la cadena por el caracter que se pasa como argumento
    System.out.println("\ntrabalenguas2 = " + trabalenguas2.split("a")); // [Ljava.lang.String;@4554617c
    // Divide la cadena en un arreglo de cadenas, separando la cadena por el caracter que se pasa como argumento
